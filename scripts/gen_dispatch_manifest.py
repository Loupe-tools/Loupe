...
# Dispatch ids with non-factory handlers in app-load.js.
DISPATCH_OVERRIDES = frozenset({
    'folder', 'docx', 'csv', 'json', 'html', 'svg', 'plist', 'scpt',
    'pe', 'elf', 'macho', 'wasm', 'pcap', 'jar', 'pdf', 'plaintext',
})
...
def generate_toml() -> str:
    ...
    for id_, cls in registry:
        ...
        override = id_ in DISPATCH_OVERRIDES or id_ == 'docx'
