...
| `vendor/geoip-country-ipv4.bin` | RIR delegated-stats snapshot **2026-07-01** | Public Domain (NRO redistribution) | `4200b2ecd0e30194b63b02a0cba385d100136734b5f7649c915bb1857224721d` | Generated by [`scripts/fetch_geoip.py`](scripts/fetch_geoip.py) from the five RIR delegated-stats files (ARIN, RIPE NCC, APNIC, AFRINIC, LACNIC) — see the script header for source URLs |
