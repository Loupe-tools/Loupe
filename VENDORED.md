...
| `vendor/geoip-country-ipv4.bin` | RIR delegated-stats snapshot **2026-06-01** | Public Domain (NRO redistribution) | `7875231441c3e477a7b51358e3728d8becf46dd7034f2e3305516e5dc7a3df76` | Generated by [`scripts/fetch_geoip.py`](scripts/fetch_geoip.py) from the five RIR delegated-stats files (ARIN, RIPE NCC, APNIC, AFRINIC, LACNIC) — see the script header for source URLs |
